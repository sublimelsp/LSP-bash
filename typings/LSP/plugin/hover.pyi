...
from ..protocol import Diagnostic as Diagnostic, DocumentLink as DocumentLink, Hover, Position as Position, Range as Range
...
class LspHoverCommand(LspTextCommand):
    ...
    def _on_resolved_link(self, session_buffer: SessionBufferProtocol, link: DocumentLink | Error) -> DocumentLink | None: ...
    def _on_all_document_links_resolved(self, listener: AbstractViewListener, point: int, links: list[DocumentLink | None]) -> None: ...
